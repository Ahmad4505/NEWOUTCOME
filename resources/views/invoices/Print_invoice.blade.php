                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row">
                                    <span>رقم الفاتورة : </span> <span>{{ $invoices->invoice_number }}</span>
                                </p>
                                <p class="invoice-info-row">
                                    <span>تاريخ الاصدار : </span> <span>{{ $invoices->invoice_Date }}</span>
                                </p>
                                <p class="invoice-info-row">
                                    <span>تاريخ الاستحقاق : </span> <span>{{ $invoices->Due_date }}</span>
                                </p>
                                <p class="invoice-info-row">
                                    <span> القسم : </span> <span>{{ $invoices->section->section_name }}</span>
                                </p>
                            </div>
                        </div>
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="tx-center">{{ $invoices->Amount_collection, 2 }}</td>
                                    ...
                                    <tr>
                                        <td class="tx-right tx-uppercase tx-bold tx-inverse">لاجمالي</td>
