											...
											<div class="main-signup-header">
												...
												<form method="POST" action="{{ route('login') }}">
													...
													<div class="form-group">
														<label>Email</label>
                                                        <input class="form-control" id="email" placeholder="Enter your email"type="email" name="email" :value="old('email')" required autofocus autocomplete="username">
													</div>
													<div class="form-group">
													...
													</div><button class="btn btn-main-primary btn-block">{{ __('Log in') }}</button>
